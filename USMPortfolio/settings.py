"""
Django settings for USMPortfolio project.
...
ROOT_URLCONF = 'USMPortfolio.urls'
...
WSGI_APPLICATION = 'USMPortfolio.wsgi.application'
...
# SMTP configurations for email setup
